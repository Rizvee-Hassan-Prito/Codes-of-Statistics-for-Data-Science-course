# -*- coding: utf-8 -*-
"""
Created on Tue May 10 18:27:09 2022
...
Log_reg_submission.to_csv("Log_reg_submission_2.csv", index = False)
...
# classifier
clf = OneVsRestClassifier(LogisticRegression(C = 0.1 , solver='newton-cg'))
